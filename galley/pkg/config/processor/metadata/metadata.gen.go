...
collections:
  ...
  - name: "k8s/core/v1beta1/mutatingwebhookconfigurations"
    proto: "k8s.io.api.admissionregistration.v1beta1.mutatingwebhookconfigurations"
    protoPackage: "k8s.io/api/admissionregistration/v1beta1"
...
snapshots:
  - name: "default"
    ...
    collections:
      ...
      - "k8s/core/v1/pods"
      - "k8s/core/v1beta1/mutatingwebhookconfigurations"
      # Legacy Mixer CRDs
...
sources:
  ...
  - type: kubernetes
    ...
    - collection: "k8s/core/v1beta1/mutatingwebhookconfigurations"
...
transforms:
  - type: direct
    mapping:
      ...
      "k8s/core/v1beta1/mutatingwebhookconfigurations": "k8s/core/v1beta1/mutatingwebhookconfigurations"
